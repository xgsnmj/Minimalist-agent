...
export function LoginPage() {
  return (
    <main className="access-page access-workbench" aria-labelledby="login-title">
      <section className="access-console" aria-label="登录">
        <header className="access-console-top">
          ...
          <span className="access-state">未登录</span>
        </header>
        ...
        <div className="access-console-main">
          ...
          <div className="access-inline-row">
            <span>无账号</span>
            <a className="secondary-link" href="/register">申请</a>
          </div>
        </div>
...
export function RegisterPage() {
  ...
  return (
    <main className="access-page access-workbench" aria-labelledby="register-title">
      <section className="access-console" aria-label="账号申请">
        <header className="access-console-top">
          <a className="access-brand" href="/login" aria-label="Minimalist Agent">
            <span className="brand-mark">MA</span>
            <span>Minimalist Agent</span>
          </a>
          <span className="access-state">申请</span>
        </header>

        <div className="access-console-main">
          <div className="access-card-header">
            <p className="eyebrow">本地账号</p>
            <h1 id="register-title">申请账号</h1>
          </div>
          ...
          <div className="access-inline-row">
            <span>已有账号</span>
            <a className="secondary-link" href="/login">登录</a>
          </div>
        </div>
